  ...
  return (
    ...
    >
      <CardContent>
        ...
        >
          Project Type: HashMap Implementation
        </Typography>
        <Typography
          variant="body2"
          component="p"
        ...
        >
          Project tools: MS visual studios and C Progaming Language
          <br />
        </Typography>
      </CardContent>
      <CardActions disableSpacing>
        <IconButton
          ...
          style={{ backgroundColor: "#333333", color: "#fff" }}
          target="_blank"
          href="https://github.com/seanmurphy355/Implementation-of-HashMap"
        >
          <GitHub />
        </IconButton>
        <IconButton
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent>
          <Typography paragraph style={{ fontWeight: 50 }}>
            Implementation of the Hashmap data structure via Spell Checker.
          </Typography>
        </CardContent>
      </Collapse>
    </Card>
